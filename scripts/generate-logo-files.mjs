...
function wordmarkSvg({ letterColor, dotColor }) {
  ...
  <text x="0" y="68" font-size="68" font-family="Space Grotesk">
...
function compactSvg({ bgColor, letterColor, dotColor }) {
  ...
  <text x="200" y="260" font-size="180" font-family="Space Grotesk" text-anchor="middle">
...
function rasterize(svg, width, fontFiles) {
  ...
  const raster_svg = svg.replaceAll('font-family="Space Grotesk"', `font-family="${RASTER_FONT_FAMILY}"`);
